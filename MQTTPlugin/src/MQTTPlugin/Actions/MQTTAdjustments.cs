    ...
    public class MQTTAdjustments : ActionEditorAdjustment
    {
        ...
        protected override BitmapImage GetCommandImage(ActionEditorActionParameters actionParameters, Int32 imageWidth, Int32 imageHeight)
        {
            using (var bitmapBuilder = new BitmapBuilder(imageWidth, imageHeight))
            {
                ...
                {
                    _image.Crop(0, 0, 32, 32); // The image can only be 64x64
                ...
                else // Return both text and image
                {
                    ...
                    bitmapBuilder.DrawImage(_image, (imageWidth - _image.Width) / 2, 0);
                    bitmapBuilder.DrawText($"{actionParameters.Parameters.GetValue("base_text")}{_text}", (imageWidth - _image.Width) / 2, 32, _image.Width, 10, color: _color);
                }
