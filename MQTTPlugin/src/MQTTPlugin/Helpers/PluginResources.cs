namespace Loupedeck.MQTTPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MQTTPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MQTTPlugin.Resources.Resource.txt`.
